...
\emph{\textsuperscript{3} K.Kulazhanov named Kazakh University of
...
%   >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.8594}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0713}}@{}}
% \toprule\noalign{}
...
%   >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.8596}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0712}}@{}}
% \toprule\noalign{}
% \begin{minipage}[b]{\linewidth}\raggedright
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% S =πD\textsuperscript{3}/d,
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% (2)
% \end{minipage} \\
% \midrule\noalign{}
...
% \begin{longtable}[]{@{}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0693}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.8595}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0712}}@{}}
% \toprule\noalign{}
% \begin{minipage}[b]{\linewidth}\raggedright
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% а\emph{= 6}М/( πD\textsuperscript{3}γ),
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% (3)
% \end{minipage} \\
% \midrule\noalign{}
...
%   >{\raggedright\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.1516}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.1334}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 12\tabcolsep) * \real{0.2001}}
...
\[w = \frac{\mathrm{\Delta}P_{к}}{h} \bullet \frac{r^{2}}{8\mu}\]
...
{\bfseries Fig. 9 - Movement of two particles on the surface of a liquid}
...
\(V_{с} = \frac{100S}{\overline{m}} = \frac{100}{\overline{m}}\sqrt{\frac{\sum_{i = 1}^{n}\left( Х_{i} - \overline{m} \right)^{2}}{n - 1}}\)\emph{,
\%}
