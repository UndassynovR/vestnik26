...
\textsuperscript{\envelope }Корреспондент-автор: e-mail: \href{mailto:uaa_77@mail.ru}{\nolinkurl{uaa\_77@mail.ru}}
\end{affiliation}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{media/ict/image41}
...
\begin{figure}[H]
	...
	\caption*{4 - сурет. Physionet дерекқорынан алынған ЭКГ}
\end{figure}
...
{\bfseries 7 - сурет. PhysioNet сайтынан 2 түрлі адам үшін алынған ЭКГ сигналды MATLAB ортасында қайта түрлендіру}
