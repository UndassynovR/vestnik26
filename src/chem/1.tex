...
}\emph{\textsuperscript{1}«Institute of Coal Chemistry and Technology»
...
{\bfseries \textsuperscript{1}Ж.М.Касенова, Ж.Е.
Джакупова\textsuperscript{2}}
...
% Specific Surface Area & \textasciitilde1100 m²/g \\
...
% \begin{longtable}[]{@{}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.5087}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.4913}}@{}}
% \toprule\noalign{}
% \begin{minipage}[b]{\linewidth}\raggedright
% \begin{figure}[H]
% 	\centering
...
{\bfseries Fig. 1- IR Spectra Analysis:}
...
{\bfseries Table 2 - Chemical indicators of purified fulvic acid solution
...
% \endlastfoot
% 1 & 2 & 3 \\
% - antioxidant content, mg/dm3
% 
% - toxic elements, mg/dm3:
% 
% -Lead (Pb)
% 
% - Arsenic (As)
...
% Name of indicators, units of measurement
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% Norm according to the regulatory document
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% Results
% \end{minipage} \\
% \midrule\noalign{}
...
% - dry matter content. \%
% 
% - aflatoxin B\textsubscript{і}. mg/l
% 
% - titratable acidity, \% & 1.0-3.5
% 
% 0.7-3.8 & 138.16±0.042
% 
% Not found
% 
% Not found
...
% 
% - 4,4 - dichlorodiphenyltrichloromethylmethane and its metabates & 0.01
% 
% 0.005 & Not found
% 
% Not found \\
...
% 
% - water soluble, mg/100 g
% 
% - B\textsubscript{1} (thiamine chloride)
% 
% -В\textsubscript{3} (pantothenic acid)
% 
% - В\textsubscript{6} (pyridoxine)
% 
% - В\textsubscript{с} (folic acid) & & Not found
% 
% Not found
% 
% Not found
...
{\bfseries Fig. 4 - Chromatograms of amino acid content in the model fulvic
acid solution}
