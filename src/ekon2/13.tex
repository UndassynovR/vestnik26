...
{\bfseries Fig. 2 - Prioritizing of features depending on respondent
preferences}
...
{\bfseries Fig. 3 - The number of successful smart city initiatives in the
...
{\bfseries Fig. 4 - Frequency of mentions of various key categories related
to the development}
...
% \begin{longtable}[]{@{}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.5553}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.4447}}@{}}
% \toprule\noalign{}
...
% \begin{longtable}[]{@{}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.5659}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.4341}}@{}}
% \toprule\noalign{}
% \begin{minipage}[b]{\linewidth}\raggedright
% Data security issue
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
% \begin{longtable}[]{@{}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.5666}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.4334}}@{}}
% \toprule\noalign{}
% \begin{minipage}[b]{\linewidth}\raggedright
...
% \begin{longtable}[]{@{}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.5686}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.4314}}@{}}
% \toprule\noalign{}
% \begin{minipage}[b]{\linewidth}\raggedright
...
%   >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.3568}}
