...
\begin{articleheader}
\sectionwithauthors{M. Zhumazhanova, R. Zhappasova, A. Oryntaeva, M. Bolsynbek}{FORMATION OF THE BUSINESS ENVIRONMENT IN KAZAKHSTAN: THE ROLE OF GOVERNMENT SUPPORT FOR ENTREPRENEURSHIP}
...
aspects. The legislative framework is constantly being improved to improve the
investment climate.

2. Support for SMEs: The government actively supports the development of
...
3. Infrastructure and market access: Kazakhstan has a well-developed
...
4. Technological innovation and digitalisation: In recent years,
...
5. International co-operation and investment: Kazakhstan actively
...
{\bfseries Fig. 1 - The dynamics of growth of registered medium and large enterprises in the}

{\bfseries Republic of Kazakhstan for 2018-2023.}

\emph{Note: Compiled by the author based on data from https://stat.gov.kz/ {[}6{]}}
...
Type of activity of legal entities                                                       & Number of enterprises \\
...
Water supply; waste collection, treatment and disposal, pollution elimination activities & 2763                \\
Supply of electricity, gas, steam, hot water and conditioned air                         & 1878                \\
\textit{Note: Compiled by the author based on data from https://stat.gov.kz [6]}         &                     
\end{tblr}
\end{table}
...
1                                                                                   & 2            & 3            & 4            & 5            \\
1272207923,3                                                                        & 1370367038,7 & 1620056904,0 & 1963862120,0 & 2228835933,0 \\
\textit{Compiled by the author on the basis of data: https://damu.kz/programmi [7]} &              &              &              &              
\end{tblr}
\end{table}
...
{\bfseries Fig. 2 - Methods and volume of entrepreneurship financing under the `National Entrepreneurship}
