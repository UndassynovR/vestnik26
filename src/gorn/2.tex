...
{\bfseries , \textsuperscript{2} D. Kazbekova}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{media/gorn/image1}
	\caption*{}
...
{\bfseries \textsuperscript{3}L. Yedilbayeva}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{media/gorn/image1}
	\caption*{}
...
{\bfseries Figure 1- Comparing leave benefits across industries}
...
{\bfseries Figure 3 - Legal instruments}
...
%   >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.7014}}@{}}
% \toprule\noalign{}
...
% \bottomrule\noalign{}
% \endlastfoot
% {\bfseries List-based approach} & Limited adaptability to modern labor
% conditions. \\
% {\bfseries Socio-economic problems and legal barriers} & Frequent
% complaints from workers not included in prescribed lists; overlapping
% professions; discrepancies. \\
% {\bfseries Assessment procedures issues} & Inaccurate data in assessment
% documents; poor quality of labor assessments and subjectivity of
% experts. \\
% {\bfseries International comparison (EU vs. USA)} & EU countries avoid
% financial rewards for hazardous work, instead focusing on ethical
% considerations and preventive measures. \\
% {\bfseries Shift in nutritional support in hazardous conditions} & Shift
% from milk to shubat or dietary supplements in oil and gas sector to
