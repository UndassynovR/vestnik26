...
% \begin{longtable}[]{@{}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.0594}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.2842}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1185}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.0008}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1038}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.0012}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1033}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.0013}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1031}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.0014}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1031}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.0013}}
...
% Humidity, \%
% \end{minipage} &
% \multicolumn{3}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1058} + 4\tabcolsep}}{%
% \begin{minipage}[b]{\linewidth}\raggedright
% Protein, \%
% \end{minipage}} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1046} + 2\tabcolsep}}{%
% \begin{minipage}[b]{\linewidth}\raggedright
% Fat,\%
% \end{minipage}} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1044} + 2\tabcolsep}}{%
% \begin{minipage}[b]{\linewidth}\raggedright
% Fiber,\%
% \end{minipage}} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1043} + 2\tabcolsep}}{%
% \begin{minipage}[b]{\linewidth}\raggedright
% Starch content,\%
% \end{minipage}} & \begin{minipage}[b]{\linewidth}\raggedright
% Ash content,\%
...
% Lentils} \\
% 1 & "Stepnaya" (Almaty region) &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1193} + 2\tabcolsep}}{%
% 5,7} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1050} + 2\tabcolsep}}{%
% 27,8} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1046} + 2\tabcolsep}}{%
% 2,6} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1044} + 2\tabcolsep}}{%
...
% \multicolumn{13}{@{}>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{1.0000} + 24\tabcolsep}@{}}{%
% Corn} \\
% 4 & "Dobrynya" (Almaty region) & 6,4 &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1047} + 2\tabcolsep}}{%
% 7,7} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1044} + 2\tabcolsep}}{%
% 1,3} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1043} + 2\tabcolsep}}{%
...
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1044} + 2\tabcolsep}}{%
% 64,4} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1201} + 2\tabcolsep}@{}}{%
% 1,36} \\
% \multicolumn{13}{@{}>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{1.0000} + 24\tabcolsep}@{}}{%
% Barley} \\
% 5 & "Arpa elite" (Almaty region) & 6,8 &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1047} + 2\tabcolsep}}{%
% 10,2} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1044} + 2\tabcolsep}}{%
% 3,5} &
...
% \multicolumn{13}{@{}>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{1.0000} + 24\tabcolsep}@{}}{%
% Rice} \\
% 9 & ``Syr Syluy'' (Kyzylorda region); & 9,7 &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1047} + 2\tabcolsep}}{%
% 7,96} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1044} + 2\tabcolsep}}{%
% 1,2} &
...
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1201} + 2\tabcolsep}@{}}{%
% 0,41} \\
% 10 & ``Aikerim'' (Kyzylorda region) & 10,5 &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1047} + 2\tabcolsep}}{%
% 6,62} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1044} + 2\tabcolsep}}{%
% 1,79} &
...
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1201} + 2\tabcolsep}@{}}{%
% 0,45} \\
% 11 & ``Marzhan'' (Kyzylorda region) & 11,5 &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1047} + 2\tabcolsep}}{%
% 7,4} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 24\tabcolsep) * \real{0.1044} + 2\tabcolsep}}{%
% 1,93} &
...
%   >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.2415}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1282}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1210}}
...
% \end{minipage}} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.2492} + 2\tabcolsep}}{%
% \begin{minipage}[b]{\linewidth}\raggedright
% Pumpkin
% \end{minipage}} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.2350} + 2\tabcolsep}}{%
% \begin{minipage}[b]{\linewidth}\raggedright
% Melon
% \end{minipage}} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.2201} + 2\tabcolsep}@{}}{%
% \begin{minipage}[b]{\linewidth}\raggedright
% Courgettes
% \end{minipage}} \\
% & & \begin{minipage}[b]{\linewidth}\raggedright
% according to GOST 7975-2013
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% sample under study
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% according to GOST 7178-2015
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% sample under study
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% according to GOST 31822-2012
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% sample under study
% \end{minipage} \\
% \midrule\noalign{}
...
% \endlastfoot
% 1 & 2 & 3 & 4 & 5 & 6 & 7 & 8 \\
% 1 & Mass fraction of fruits (in case of calibration) that do not meet
% calibration requirements, \%, no more than & 10,0 & 4,0 & 10,0 & 5,0 &
% 5,0 & 3,0 \\
% 2 & Mass fraction of bruised and mechanically damaged fruits, \%. no
% more than & not allowed & not found & not allowed & not found & not
% allowed & not found \\
% 3 & Mass fraction of foreign impurities (twigs, stalks, leaves). \%, no
% more than & not allowed & not found & not allowed & not found & not
% allowed & not found \\
% 4 & The presence of rotten, withered, moldy and dry fruits & not allowed
% & not found & not allowed & not found & not allowed & not found \\
% 5 & Presence of agricultural pests and their waste products & not
% allowed & not found & not allowed & not found & not allowed & not
% found \\
% \end{longtable}
...
% \begin{longtable}[]{@{}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.0402}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.1191}}
...
%   >{\raggedright\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.0941}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.0740}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.0941}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.0741}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.0941}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.0741}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.0940}}
%   >{\raggedright\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.0741}}@{}}
% \toprule\noalign{}
% \multirow{2}{=}{\begin{minipage}[b]{\linewidth}\raggedright
% №
...
% Name of raw material
% \end{minipage}} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.1682} + 2\tabcolsep}}{%
% \begin{minipage}[b]{\linewidth}\raggedright
% Apple
% \end{minipage}} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.1681} + 2\tabcolsep}}{%
% \begin{minipage}[b]{\linewidth}\raggedright
% Apricot
% \end{minipage}} &
% \multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 22\tabcolsep) * \real{0.1682} + 2\tabcolsep}}{%
...
% \end{minipage}} \\
% & & \begin{minipage}[b]{\linewidth}\raggedright
% according to GOST 27572-2017
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% sample under study
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% according to GOST 32787-2014
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% sample under study
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% according to GOST 33915-2016
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% sample under study
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% according to GOST 33954-2016
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% sample under study
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% according to GOST R 59661-2021
% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
% sample under study
% \end{minipage} \\
% \midrule\noalign{}
...
% 1 & Fruit size by largest transverse diameter, cm, not less than & 6,0 &
% 7,0 & 10,0 & 12,0 & - & - & - & - & - & - \\
% 2 & Mass fraction of berries that do not correspond to the commercial
% grade, but correspond to a lower grade, \%, no more than & - & - & - & -
% & 5,0 & 3,0 & 5,0 & 2,0 & - & - \\
% 3 & Mass fraction of fruits that have not reached removable maturity and
% color. \%, not more than & - & - & - & - & - & - & - & - & 2,0 & 1,0 \\
% 4 & Mass fraction of bruised and mechanically damaged fruits, \%. no
% more than & not allowed & not found & not allowed & not found & - & - &
% - & - & 5,0 & 3,0 \\
% 5 & Mass fraction of foreign impurities (twigs, stalks, leaves). \%, no
% more than & not allowed & not found & not allowed & not found & 0,3 &
% 0,1 & 0,3 & 0,2 & 1,0 & 0,5 \\
% 6 & The presence of rotten, withered, moldy and dry fruits & not allowed
% & not found & not allowed & not found & not allowed & not found & not
% allowed & not found & not allowed & not found \\
% 7 & Presence of agricultural pests and their waste products & not
% allowed & not found & not allowed & not found & not allowed & not found
% & not allowed & not found & not allowed & not found \\
% \end{longtable}
